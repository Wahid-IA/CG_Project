...
public class BanditBoss : MonoBehaviour
{
    ...
    public Collider weaponHitbox; // <--- Assigned in the Inspector here
    ...
    void Start()
    {
        ...
        // Keep weapon hitbox turned off until an attack swing occurs
    ...
    // Called via Animation Events during attack swings
    ...
    {
        if (isDead) return;
        isAwakened = true; // Wake up immediately if attacked from distance
